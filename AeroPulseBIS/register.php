                    ...
                    <div class="login-content">
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    if ($tc_control) 
                                                    {
                                                        ...
                                                        {
                                                            $sql = mysqli_query($baglan,"INSERT INTO kullanici(ad,soyad,tel_no,cinsiyet,tc_no,sifre,dogum_tarihi,engelli,kullanici_tip_id,meslek_id) values('$ad','$soyad','$tel','$cinsiyet','$tc_no','$sifre','$dogum','$engelli','2','$meslek')");
                                                            if ($sql) {
                                                                echo '<script>Swal.fire({
                                                                    title: "Başarılı!",
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                ?>
                                <br><br>
                                <button class="au-btn au-btn--block au-btn--green m-b-20" name="submit" type="submit">Kayıt Ol</button>
                            </form>
