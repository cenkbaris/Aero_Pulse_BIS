...
$giris_zamani = $_SESSION['giris_tarih_saat'];
$cikis_zamani = date("Y-m-d H:i:s");
$userID = $_SESSION['kullanici_id'];
$log = mysqli_query($baglan,"INSERT INTO log_kaydi (ip_adresi, tarayici_adi, giris_tarihi, cikis_tarihi, kullanici_id) VALUES ('$ip_adresi', '$tarayici', '$giris_zamani', '$cikis_zamani', '$userID')");
