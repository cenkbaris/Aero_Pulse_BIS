        ...
        <div class="col-md-12 border-right">
            <div class="p-3 py-5">
                ...
                <?php                           
                                                ...
                                                $yenicinsiyet = $_POST['cinsiyet'];                                          
                                                
                                                
                                                
                                                if($_POST['updateProfil']){ 
                                                                            
                                                    if(!$yeniad|| !$yenisoyad || !$yenidogum || !$yenitelno || !$yenimeslek ||!$yenicinsiyet){
                                                      echo '<script>Swal.fire({
                                                        ...
                                                        tel_no='$yenitelno',meslek_id='$yenimeslek',cinsiyet='$yenicinsiyet' WHERE kullanici.kullanici_id = $userID") ;
              ...
              <form method="POST">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-4"><label class="labels">Cinsiyet</label>
                      <select type="text" class="form-control" name="cinsiyet">
                      <?php if($cinsiyet=="Erkek")
                      {
                        echo '<option value="Kadın">Kadın</option>';
                        echo '<option value="'.$cinsiyet.'"selected >'.$cinsiyet.'</option>';
                      }
                      else if($cinsiyet =="Kadın")
                      {
                        echo '<option value="Kadın">Erkek</option>';
                        echo '<option value="'.$cinsiyet.'"selected >'.$cinsiyet.'</option>';
                      }
                      ?>
                    </select>
